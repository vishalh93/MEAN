...
// =================================editFun =============================================
cid1; sid1; ssid1; bid1; pname1;prating1;pcolor1;pprice1;pdesc1;
  editFun(p){
    this.glob_id = p._id;
    this.cid1 = p.catid;
    this.sid1 = p.scatid;
...
// ==================================insert product =====================================
pname;msg1;msg2;msg3;msg4;msg5;msg6;msg7;msg8;msg10;;
bid="";
prating; pcolor ;pprice;pdesc;
insProducts(vld){
  if(vld.valid){
  var proob ={catid:this.cid, scatid:this.sid, sscatid:this.ssid, brd_id:this.bid, product_name:this.pname ,product_rating:this.prating, product_color:this.pcolor , product_price:this.pprice, description:this.pdesc}
